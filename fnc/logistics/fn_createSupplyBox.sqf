...
_boxType = ["OPTRE_Ammo_Magic_Box","O_supplyCrate_F","I_supplyCrate_F"] select ([west,east,resistance] find _side);

_ammobox = createVehicle [_boxType,[0,0,0],[],0,"CAN_COLLIDE"];
_ammobox setVariable ["PO3_loadout_boxID",[_side,_boxid],true];
_ammobox addAction["<t color='#111111'>Gear Select</t>", "execvm 'ASORGS\open.sqf'"];
...
[player,"HINT","You have created a supplybox<br/><br/>You can transport the supply box by loading it onto a truck or using a helicopter to slingload it to its destination.<br/><br/>It will be recovered as soon as nearby players leave its vicinity."] call PO3_fnc_hint;