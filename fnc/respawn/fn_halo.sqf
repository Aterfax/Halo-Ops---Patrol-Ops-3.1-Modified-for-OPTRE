...
_droppod = createVehicle ["TEI_HEV", _position, [], 10, "FLY"];
_unit MoveInDriver _droppod;
//_droppod enableSimulation false;
//createVehicle ["TEI_HEV", _position _unit, [], 0, "FLY"];
...
waitUntil { count crew vehicle _droppod == 0};
_droppod setVehicleLock "LOCKED";
sleep 10;
deleteVehicle _droppod;
